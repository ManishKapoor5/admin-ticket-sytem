// // components/ticket-dashboard.jsx

// "use client";

// import React, { useState, useEffect } from "react";
// // ... (other imports)
// import { getTickets } from "../services/api"; // Updated import
...
//       try {
//         const response = await getTickets({ status: filterStatus });
...
//   // ... (add functions to handle createTicket, pickTicket)
...
//                 <span className={`status-badge ${ticket.status}`}>{ticket.status.replace("-", " ")}</span>
...
//                     <span className="escalated-text">
//                       Escalated {new Date(ticket.escalatedAt).toLocaleDateString()}
//                     </span>
//                   </>
//                 )}
//               </div>
...
//                 {!ticket.assignedTo && <button className="action-button primary">Pick Ticket</button>}
//               </div>
//             </div>
//           </div>
//         ))}
...
//         description="Create a new support ticket for client issues"
//       >
